						...
						<span class="span3">
							<span class="pull-right">
								{if $COMMENTS_WIDGET_MODEL->get('action')}
									<button class="btn btn-success pull-right addButton createRecord" type="button" data-url="{$COMMENTS_WIDGET_MODEL->get('actionURL')}" title="{vtranslate('LBL_ADD',$MODULE_NAME)}"><i class="fa fa-plus"></i>
									</button>
								{/if}
							</span>
						</span>
						...
						<span class="pull-right">
							<span class="pull-right">
								{if $DOCUMENT_WIDGET_MODEL->get('action')}
									<button class="btn btn-success pull-right addButton createRecord" type="button" data-url="{$DOCUMENT_WIDGET_MODEL->get('actionURL')}" title="{vtranslate('LBL_ADD',$MODULE_NAME)}"><i class="fa fa-plus"></i>
									</button>
								{/if}
							</span>
						</span>
						...
						<span class="span3">
							<span class="pull-right">
								{if $UPDATES_WIDGET_MODEL->get('action')}
									<button class="btn btn-success pull-right addButton createRecord" type="button" data-url="{$UPDATES_WIDGET_MODEL->get('actionURL')}" title="{vtranslate('LBL_ADD',$MODULE_NAME)}"><i class="fa fa-plus"></i>
									</button>
								{/if}
							</span>
						</span>
