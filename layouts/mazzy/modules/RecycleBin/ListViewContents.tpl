			...
			<td nowrap class="{$WIDTHTYPE}">
				<div class="actions">
					<span class="actionImages">
						<a class="restoreRecordButton btn btn-xs btn-peas tooltips "><i title="{vtranslate('LBL_RESTORE', $MODULE)}" class="icon-refresh alignMiddle"></i></a>&nbsp;
						<a class="deleteRecordButton btn btn-xs btn-red tooltips "><i title="{vtranslate('LBL_DELETE', $MODULE)}" class="icon-trash alignMiddle"></i></a>
					</span>
				</div>
			</td>
			{foreach item=LISTVIEW_HEADER from=$LISTVIEW_HEADERS}
