        ...
        <div class="relatedHeader ">
            <div class="btn-toolbar row-fluid">
                <div class="span6">
                    ...
                    {/if}
            {if $IS_SELECT_BUTTON neq true}name="composeEmail"{/if}>{if $IS_SELECT_BUTTON eq false}<i class="fa fa-plus"></i>{/if}&nbsp;<strong>{$RELATED_LINK->getLabel()}</strong></button>
    </div>
{/foreach}
&nbsp;
</div>
                    ...
                    <td>
                          <div class="pull-right actions">
                                    <span class="actionImages">
                                        <a name="emailsDetailView" class="btn btn-blue btn-xs"><i title="{vtranslate('LBL_SHOW_COMPLETE_DETAILS', $MODULE)}" class="fa fa-th-list alignMiddle"></i></a>&nbsp;
                                        {if !($RELATED_RECORD->isSentMail())}
                                            <a name="emailsEditView" class="btn btn-green btn-xs"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="fa fa-pencil alignMiddle"></i></a> 
                                        {/if}
                                        {if $IS_DELETABLE}
                                            <a class="relationDelete btn btn-red btn-xs"><i title="{vtranslate('LBL_DELETE', $MODULE)}" class="fa fa-trash alignMiddle"></i></a>
                                        {/if}
                                    </span>
                                </div>
                    </td>
