...
{strip}
    <div class='container-fluid editViewContainer'>
        <form class="form-horizontal recordEditView detailViewInfo" id="EditView" name="EditView" method="post" action="index.php" enctype="multipart/form-data">
                        ...
                        {foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
                            ...
                            {if $isReferenceField eq "reference"}
                                ...
                                {if $REFERENCE_LIST_COUNT > 1}
                                    ...
                                    <label class="muted pull-right marginRight10px">{vtranslate($FIELD_MODEL->get('label'), $MODULE)}
            ...
            {if $FIELD_MODEL->get('uitype') neq "83"}
                <div class="span{if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20'}10{else}4{/if} mycdivfield" {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20'} style='width:85%!important' {assign var=COUNTER value=$COUNTER+1} {/if}>
                  
                            {include file=vtemplate_path($FIELD_MODEL->getUITypeModel()->getTemplateName(),$MODULE) BLOCK_FIELDS=$BLOCK_FIELDS}                </div>
            {/if}
