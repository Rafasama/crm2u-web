...
{* <script> resources below *}
	...
	{foreach key=index item=jsModel from=$SCRIPTS}
            {if $jsModel->getSrc() eq "modules/Vtiger/resources/validator/FieldValidator.js" }
				<script type="{$jsModel->getType()}" src="layouts/mazzy/modules/Vtiger/resources/validator/FieldValidator.js"></script>
			{else}
