	...
	{if $LISTVIEW_LINKS['LISTVIEWSETTING']|@count gt 0}
		<div class="settingsIcon">
			<span class="pull-right btn-group">
				<button class="btn dropdown-toggle" href="#" data-toggle="dropdown"><i class="fa fa-cog" alt="{vtranslate('LBL_SETTINGS', $MODULE)}" title="{vtranslate('LBL_SETTINGS', $MODULE)}"></i> <i class="fa fa-caret-down"></i></button>
