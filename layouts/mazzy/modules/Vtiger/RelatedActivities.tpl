...
<div  class="summaryWidgetContainer">
	<div class="widget_header row-fluid">
		...
		<span class="span4"><button class="btn btn-success pull-right createActivity" data-url="sourceModule={$RECORD->getModuleName()}&sourceRecord={$RECORD->getId()}&relationOperation=true" type="button"><i class="fa fa-plus" title="{vtranslate('LBL_ADD',$MODULE_NAME)}"></i></button></span>
	</div>
