        ...
        <form id="exportForm" class="form-horizontal row-fluid" method="post" action="index.php">
            ...
            <div class="row-fluid">
                ...
                <div class="span8">
                    ...
                    <div class="summaryView exportContents marginLeftZero">
                        <div class="row-fluid">
                    ...
                    <div class="textAlignCenter">
                        ...
                        <a class="btn btn-danger cancelLink" type="reset" onclick='window.history.back()'>{vtranslate('LBL_CANCEL', $MODULE)}</a>
                    </div>
                </div>
            </div>
        </div>
