...
jQuery.Class("Vtiger_List_Js",{
   ...
   getInstance: function(){
	...
	updatePagination : function(){
		...
		var pageJumpButton = jQuery('#listViewPageJump, .listViewPageJump');
	...
	*/
	...
	showPagingInfo : function(){
		...
		if(jQuery('#myctotrecords').length) jQuery('#myctotrecords').html();
		else pageNumberElement.append("<div id='myctotrecords'></div>");
		
		//var newPagingInfo = pageRange+" "+app.vtranslate('of')+" "+totalNumberOfRecords;
		var listViewEntriesCount = parseInt(jQuery('#noOfEntries').val());
		if(listViewEntriesCount != 0){
			//pageNumberElement.append("<div id='myctotrecords'>"+app.vtranslate('of')+""+totalNumberOfRecords+"</div>");
			jQuery('#myctotrecords').html(app.vtranslate('of')+" "+totalNumberOfRecords);
		} else {
