...
//        }
    ...
    basicSearch: function() {
        var thisInstance = this;
        jQuery('#globalSearchValue, #globalSearchValue_mob').keypress(function(e) {
    ...
    registerEvents: function() {
        ...
        jQuery('#searchIcon_mob').on('click', function(e) {
            var currentTarget = jQuery('#globalSearchValue_mob');
            var pressEvent = jQuery.Event("keypress");
            pressEvent.which = 13;
            currentTarget.trigger(pressEvent);
        });
