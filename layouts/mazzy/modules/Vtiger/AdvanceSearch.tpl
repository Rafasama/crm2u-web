...
{strip}
    <div id="advanceSearchContainer">
        ...
        <div class="actions modal-footer">
            <a class="cancelLink btn btn-danger pull-right" type="reset" id="advanceSearchCancel" data-dismiss="modal">{vtranslate('LBL_CANCEL', $MODULE)}</a>
            ...
            <div class="pull-right">
                {if $SAVE_FILTER_PERMITTED}
                    ...
                    <button class="btn btn-success pull-right" {if $SOURCE_MODULE eq 'Home'} disabled="" {/if} id="advanceIntiateSave"><strong>{vtranslate('LBL_SAVE_AS_FILTER', $MODULE)}</strong></button>
