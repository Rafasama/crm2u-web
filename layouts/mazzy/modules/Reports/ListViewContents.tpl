					...
					{if $LISTVIEW_HEADER@last}
						...
						<div class="pull-right actions">
							<span class="actionImages">
								<a class="btn btn-xs btn-yellow" href='{$LISTVIEW_ENTRY->getEditViewUrl()}'><i class="icon-pencil"></i></a>&nbsp;
								{if $LISTVIEW_ENTRY->isDefault() eq false}
									<a class="btn btn-xs btn-red deleteRecordButton"><i class="icon-trash"></i></a>
								{/if}
							</span>
						</div>
						</td>
