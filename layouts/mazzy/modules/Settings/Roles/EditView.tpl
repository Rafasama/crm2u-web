	...
	<div class="container-fluid">
		...
		<form name="EditRole" action="index.php" method="post" id="EditView" class="form-horizontal">
			...
			<div style="padding:20px;">
				<div class="row-fluid">
					<div class="span3"><label><strong>{vtranslate('LBL_NAME', $QUALIFIED_MODULE)}<span class="redColor">*</span>: </strong></label></div>
					<div class="span8"><input type="text" class="fieldValue span7" name="rolename" id="profilename" value="{$RECORD_MODEL->getName()}" data-validation-engine='validate[required]'  /></div>
				</div><br>
				<div class="row-fluid">
					<div class="span3"><label><strong>{vtranslate('LBL_REPORTS_TO', $QUALIFIED_MODULE)}: </strong></label></div>
                ...
                <div class="row-fluid">
					<div class="span3"><label><strong>{vtranslate('LBL_CAN_ASSIGN_RECORDS_TO', $QUALIFIED_MODULE)}: </strong></label></div>
					<div class="row span9 fieldValue">
						<div class="span">
				...
				<div class="row-fluid">
					<div class="span3"><label><strong>{vtranslate('LBL_PRIVILEGES',$QUALIFIED_MODULE)}:</strong></label></div>
					<div class="row span9 fieldValue">
						<div class="span">
