    ...
    <div class="summaryWidgetContainer">
        <label class="checkbox">
            ...
            <span style="margin-left:25px">
                <i class="btn btn-xs btn-blue fa fa-info-circle"></i>
	...
	<table class="table table-bordered profilesEditView">
		...
		<tbody>
			...
			{foreach from=$PROFILE_MODULES key=TABID item=PROFILE_MODULE}
				...
				<tr class="hide">
					<td colspan="6" class="" >
						<div class=" hide" data-togglecontent="{$TABID}-fields">
							{if $PROFILE_MODULE->getFields()}
								<div class="span12">
			...
			<tr class="hide">
				<td colspan="6" class="" style="padding-left: 5%;padding-right: 5%;background-image: none !important;">
					<div class="hide" data-togglecontent="{$TABID}-fields">
						<div class="span12" style="width: 100%;"><label class="themeTextColor font-x-large pull-left"><strong>{vtranslate('LBL_TOOLS',$QUALIFIED_MODULE)}</strong></label></div>
