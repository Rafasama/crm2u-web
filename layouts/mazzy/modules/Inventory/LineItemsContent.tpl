...
{strip}
	...
	<td>
		<a class="pull-left"><img src="{vimage_path('drag.png')}" border="0" title="{vtranslate('LBL_DRAG',$MODULE)}"/></a>
		<input type="hidden" class="rowNumber" value="{$row_no}" />
		&nbsp;&nbsp;&nbsp;
		<a class="pull-right btn btn-xs btn-red deleteRow"><i class="fa fa-trash  cursorPointer" title="{vtranslate('LBL_DELETE',$MODULE)}"></i></a>
	</td>
	<td>
		...
		<div>
			...
			{if $row_no eq 0}
			<a class="btn lineItemPopup"  data-popup="ServicesPopup"  title="{vtranslate('Services',$MODULE)}" data-module-name="Services" data-field-name="serviceid">
				<i class="fa fa-globe"></i>
			</a>
			<a class="btn lineItemPopup"  data-popup="ProductsPopup"  title="{vtranslate('Products',$MODULE)}" data-module-name="Products" data-field-name="productid">
				<i class="fa fa-cube"></i>
			</a>
			<a class="btn btn-red clearLineItem"  title="{vtranslate('LBL_CLEAR',$MODULE)}" >
			...
			{else}
				...
				<a class="btn lineItemPopup"  data-popup="ServicesPopup"  title="{vtranslate('Services',$MODULE)}" data-module-name="Services" data-field-name="serviceid">
				<i class="fa fa-globe"></i>
			</a><a class="btn btn-red  clearLineItem"  title="{vtranslate('LBL_CLEAR',$MODULE)}" >
				 <i class="fa fa-times"></i>
			</a>
	...
	<td>
		<div>
			...
			{if $PRICEBOOK_MODULE_MODEL->isPermitted('DetailView')}
				<a class="btn btn-green cursorPointer priceBookPopup" data-popup="Popup" data-module-name="PriceBooks"><i class="fa fa-book"></i></a>
			{/if}
		</div>
		<div>
			<span>
