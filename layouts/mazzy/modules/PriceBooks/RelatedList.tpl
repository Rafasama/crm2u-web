                   ...
                   <td nowrap class="{$WIDTHTYPE}">
                                <div class="pull-right actions">
                                    <span class="actionImages">
                                        <a class="btn btn-xs btn-blue" ref="{$RELATED_RECORD->getFullDetailViewUrl()}"><i class="icon-th-list"></i></a>&nbsp;
                                        <a data-url="index.php?module=PriceBooks&view=ListPriceUpdate&record={$PARENT_RECORD->getId()}&relid={$RELATED_RECORD->getId()}&currentPrice={$LISTPRICE}"
                                           class="editListPrice cursorPointer btn btn-xs btn-green" data-related-recordid='{$RELATED_RECORD->getId()}' data-list-price={$LISTPRICE}>
                                            <i class="icon-pencil"></i>
                                        </a>&nbsp;
                                        <a class="relationDelete btn btn-xs btn-red"><i class="icon-trash"></i></a>&nbsp;
                                    </span>
                                </div>
                            </td>
                             {foreach item=HEADER_FIELD from=$RELATED_HEADERS}
