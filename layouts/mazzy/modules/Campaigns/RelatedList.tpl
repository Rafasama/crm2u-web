        ...
        <div class="relatedContainer listViewPageDiv margin0px">
            ...
            <div class="relatedHeader">
                ...
                {if ($IS_SELECT_BUTTON eq false) and ($IS_SEND_EMAIL_BUTTON eq false)}
                    name="addButton"><i class="fa fa-plus"></i>
                {else}
...
<div class="span3">
    <div class="pull-right">
        <span class="pageNumbers">
            ...
            <span class="fa fa-refresh cursorPointer totalNumberOfRecords{if empty($RELATED_RECORDS)} hide{/if}"></span>
        </span>
        ...
        <table class="table table-bordered listViewEntriesTable">
            <thead>
                <tr class="listViewHeaders">
                    ...
                    <th width="3%">
                    <a href="javascript:void(0);" class="noSorting">{vtranslate('Actions')}</a>
                </th>
                ...
                <tr class="listViewEntries" data-id='{$RELATED_RECORD->getId()}' data-recordUrl='{$RELATED_RECORD->getDetailViewUrl()}'>
                    ...
                    <td nowrap class="{$WIDTHTYPE}">
                        <span class="currentStatus btn-group">
                            ...
                            <a class="btn btn-darkyellow btn-xs statusValue dropdown-toggle" data-toggle="dropdown"><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="fa fa-tag alignMiddle editRelatedStatus"></i></a>
                    ...
                    <td nowrap class="{$WIDTHTYPE}">
                        <div class="pull-right actions">
                            <span class="actionImages">
                                <a class="btn btn-xs btn-black " href="{$RELATED_RECORD->getFullDetailViewUrl()}"><i title="{vtranslate('LBL_SHOW_COMPLETE_DETAILS', $MODULE)}" class="fa fa-th-list alignMiddle"></i></a>&nbsp;
                                {if $IS_EDITABLE}
                                    <a class="btn btn-xs btn-yellow " href='{$RELATED_RECORD->getEditViewUrl()}'><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="fa fa-pencil alignMiddle"></i></a>
                                {/if}
                                {if $IS_DELETABLE}
                                    <a class="btn btn-xs btn-red  relationDelete"><i title="{vtranslate('LBL_DELETE', $MODULE)}" class="fa fa-trash alignMiddle"></i></a>
                                {/if}
                            </span>
                        </div>
                    </td>
