...
jQuery.Class("Calendar_CalendarView_Js",{
	...
	registerCalendar : function(customConfig) {
		...
		jQuery('<span class="pull-right" style="margin-left:10px"><button class="btn addButton btn-sm"><i class="fa fa-plus"></i></button></span>')
		...
		jQuery('<span class="pull-right marginLeft5px"><button class="btn btn-sm"><i id="calendarSettings" class="fa fa-cog"></i></button></span>')
		.prependTo(calendarview.find('.fc-header .fc-header-right')).on('click', 'button', function(e){
			var params = {
				module : 'Calendar',
				view : 'Calendar',
