...
<div class="row gridRow">
	<div class="span12 mycQuickSearchFieldsTags" style="display:none">
...
{if $IS_MODULE_EDITABLE && $EDIT_VIEW_URL && $LISTVIEW_ENTRY->get('taskstatus') neq 'Held' && $LISTVIEW_ENTRY->get('taskstatus') neq 'Completed'}
                            <a class="btn btn-sm btn-cyan markAsHeld"><i title="{vtranslate('LBL_MARK_AS_HELD', $MODULE)}" class="fa fa-check alignMiddle"></i></a>&nbsp;
                        {/if}
