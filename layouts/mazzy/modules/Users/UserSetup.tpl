...
#myclogin { background: url(/layouts/mazzy/skins/images/proseguo_puestadelsoltenerife.jpg) no-repeat fixed center;    background-size: cover; }
...
input[type="text"]:focus, input[type="password"]:focus {    border-bottom: 1px solid #039BE5 !important;}
			...
			<div class="row-fluid">
				...
				<div class="" {if false && $IS_FIRST_USER}style="width: 700px;"{/if}> {* FirstUser information gather - paused *}
