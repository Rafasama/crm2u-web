...
{strip}
    <div id="massEditContainer" class='modelContainer'>
        ...
        <form class="form-horizontal recordEditView" id="changePassword" name="changePassword" method="post" action="index.php">
                ...
                <div class="modal-body tabbable">
                    ...
                    <div class="row">
                        {if !$CURRENT_USER_MODEL->isAdminUser()}
                            <label class="span4">{vtranslate('LBL_OLD_PASSWORD', $MODULE)}</label>
                            <div class="span8">
                    ...
                    <div class="row">
                        <label class="span4">{vtranslate('LBL_NEW_PASSWORD', $MODULE)}</label>
                        <div class="span8">
                    ...
                    <div class="row">
                        <label class="span4">{vtranslate('LBL_CONFIRM_PASSWORD', $MODULE)}</label>
                        <div class="span8">
