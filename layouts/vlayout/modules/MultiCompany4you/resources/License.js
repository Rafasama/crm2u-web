...
if (typeof (MultiCompany4you_License_Js) == 'undefined') {

    MultiCompany4you_License_Js = {
        editLicense: function($type) {
            ...
            url = "index.php?module=MultiCompany4you&view=IndexAjax&mode=editLicense&type=" + $type + "&key=" + license_key;
        ...
        saveLicenseKey: function(form, is_install) {
            ...
            if (is_install)
            {
                ...
                //params = "index.php?module=MultiCompany4you&action=License&mode=editLicense&type=activate&licensekey="+licensekey_val;
                params = {};
                params.module = "MultiCompany4you";
        ...
        deactivateLicense: function() {
            ...
            var license_key = jQuery('#license_key_val').val();
            var deactivateActionUrl = 'index.php?module=MultiCompany4you&action=License&mode=deactivateLicense&key=' + license_key;
            ...
            AppConnector.request(deactivateActionUrl + '&type=control').then(
                    function(data) {
                        if (data.success == true) {
                            ...
                            {
                                //var message = app.vtranslate('LBL_DEACTIVATE_QUESTION', 'MultiCompany4you');
                                var message = data.result.question;
