...
class MultiCompany4you_CompanyList_View extends Settings_Vtiger_Index_View {
    ...
    private function getCompaniesList() {
        $adb = PearDatabase::getInstance();
        $Companies = Array();
        $res = $adb->pquery("SELECT its4you_multicompany4you.*, vtiger_role.rolename FROM its4you_multicompany4you LEFT JOIN vtiger_role ON vtiger_role.roleid=its4you_multicompany4you.role COLLATE utf8_unicode_ci");
