...
class MultiCompany4you_CompanyDetails_Model extends Settings_Vtiger_Module_Model {
    ...
    public static function getInstance() {
        ...
        $db = PearDatabase::getInstance();
        $sql = "SELECT its4you_multicompany4you.*, vtiger_role.rolename FROM its4you_multicompany4you LEFT JOIN vtiger_role ON vtiger_role.roleid=its4you_multicompany4you.role COLLATE utf8_unicode_ci";
