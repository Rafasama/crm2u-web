<?php /* Smarty version Smarty-3.1.7, created on 2017-04-24 22:39:38
         compiled from "/home/rz2ac608/public_html/crm2u.com.br/poc/includes/runtime/../../layouts/vlayout2/modules/Vtiger/Header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:121661792358fe7eaaf1ab52-09850891%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3d9c982fd40d06e011a6c6d30a3c393648c1e8d9' => 
    array (
      0 => '/home/rz2ac608/public_html/crm2u.com.br/poc/includes/runtime/../../layouts/vlayout2/modules/Vtiger/Header.tpl',
      1 => 1493073575,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '121661792358fe7eaaf1ab52-09850891',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58fe7eab08bc9',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58fe7eab08bc9')) {function content_58fe7eab08bc9($_smarty_tpl) {?>
...
" /><?php } ?><link href="layouts/vlayout2/skins/style.css" rel="stylesheet" type="text/css" /><style type="text/css">@media print {.noprint { display:none; }}</style><script type="text/javascript" src="libraries/jquery/jquery.min.js"></script><!--[if IE]><script type="text/javascript" src="libraries/html5shim/html5.js"></script><script type="text/javascript" src="libraries/html5shim/respond.js"></script><![endif]--></head><body data-skinpath="<?php echo $_smarty_tpl->tpl_vars['SKIN_PATH']->value;?>
" data-language="<?php echo $_smarty_tpl->tpl_vars['LANGUAGE']->value;?>
" style="font-family: "Source Sans Pro","Helvetica Neue",Helvetica,Arial,sans-serif !important;font-size: 14px !important;"><div id="js_strings" class="hide noprint"><?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['LANGUAGE_STRINGS']->value);?>
...
" /><div id="page" class="wrapper"><!-- container which holds data temporarly for pjax calls --><div id="pjaxContainer" class="hide noprint"></div>
<?php }} ?>