<?php /* Smarty version Smarty-3.1.7, created on 2017-05-08 01:06:37
         compiled from "/home/rz2ac608/public_html/crm2u.com.br/poc/includes/runtime/../../layouts/mazzy/modules/Settings/Workflows/Step2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2115698270590fc49da89903-39396754%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f4f1aed9b16d78712dd37d679286a34e80ae29ff' => 
    array (
      0 => '/home/rz2ac608/public_html/crm2u.com.br/poc/includes/runtime/../../layouts/mazzy/modules/Settings/Workflows/Step2.tpl',
      1 => 1494194836,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2115698270590fc49da89903-39396754',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_590fc49db7ea0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_590fc49db7ea0')) {function content_590fc49db7ea0($_smarty_tpl) {?>
...
" /><input type="hidden" name="schdate" value=<?php echo $_smarty_tpl->tpl_vars['WORKFLOW_MODEL']->value->get('schdate');?>
 ...
 /><div class="summaryView"><?php if ($_smarty_tpl->tpl_vars['IS_FILTER_SAVED_NEW']->value==false){?><div class="alert alert-info"><?php echo vtranslate('LBL_CREATED_IN_OLD_LOOK_CANNOT_BE_EDITED',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</div></div><br><div class="pull-right"><button class="btn btn-blue backStep" type="button"><strong><?php echo vtranslate('LBL_BACK',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</strong></button><a class="btn btn-danger cancelLink" type="reset" onclick="javascript:window.history.back();"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
