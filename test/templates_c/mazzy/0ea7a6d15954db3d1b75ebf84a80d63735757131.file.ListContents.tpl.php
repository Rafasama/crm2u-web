<?php /* Smarty version Smarty-3.1.7, created on 2017-05-08 13:04:48
         compiled from "/home/rz2ac608/public_html/crm2u.com.br/poc/includes/runtime/../../layouts/mazzy/modules/Settings/ModuleManager/ListContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:43575396559106cf0cbc727-18282651%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ea7a6d15954db3d1b75ebf84a80d63735757131' => 
    array (
      0 => '/home/rz2ac608/public_html/crm2u.com.br/poc/includes/runtime/../../layouts/mazzy/modules/Settings/ModuleManager/ListContents.tpl',
      1 => 1494194836,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '43575396559106cf0cbc727-18282651',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59106cf10946a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59106cf10946a')) {function content_59106cf10946a($_smarty_tpl) {?>
...
"><i class="fa fa-download"></i></a><?php }?>&nbsp;</span><span class="span2 moduleImage <?php if (!$_smarty_tpl->tpl_vars['MODULE_ACTIVE']->value){?>dull <?php }?>"><?php if (vimage_path(($_smarty_tpl->tpl_vars['MODULE_NAME']->value).('.png'))!=false){?><img class="alignMiddle" src="<?php echo vimage_path(($_smarty_tpl->tpl_vars['MODULE_NAME']->value).('.png'));?>
...
</strong>&nbsp;<i class="fa fa-caret-down"></i></button><ul class="dropdown-menu pull-right"><?php  $_smarty_tpl->tpl_vars['SETTINGS_LINK'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['SETTINGS_LINK']->_loop = false;
...
</a></li><?php } ?></ul></span></span><?php }?></div><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?></td><?php } ?></tr></table></div><div class="row-fluid" style="padding: 20px 0px;"><a class="btn btn-success" href="<?php echo $_smarty_tpl->tpl_vars['IMPORT_USER_MODULE_FROM_FILE_URL']->value;?>
